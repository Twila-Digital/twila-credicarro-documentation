...
<Card title="Precisa de ajuda?" icon="headset" color="#25c2a0">
  Nossa equipe está disponível para auxiliar na implementação de webhooks. Entre em contato pelo e-mail <Icon icon="envelope" type="solid"/> atendimento@credicarro.com.br
</Card>
